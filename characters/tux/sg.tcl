...
objcreate {s_sganim} {sg:tuxroot} \
	{-bound_animations} {{( anim:crashing:tuxroot-rotateZ , z_rotation , 0 )} {( anim:trick_left:tuxroot-rotateY , y_rotation , 0 )} {( anim:trick_right:tuxroot-rotateY , y_rotation , 0 )} {( anim:trick_front:tuxroot-rotateX , x_rotation , 0 )} {( anim:trick_back:tuxroot-rotateX , x_rotation , 0 )} {( anim:left_turn:tuxroot-rotateY , y_radians , 0 )} {( anim:right_turn:tuxroot-rotateY , y_radians , 0 )} {( anim:flap:tuxroot-translateZ , z_translation , 0 )} {( anim:flap:tuxroot-rotateX , x_radians , 0 )} {( anim:flap_trans:tuxroot-rotateX , x_radians , 0 )} {( anim:paddle:tuxroot-translateY , y_translation , 0 )} {( anim:paddle:tuxroot-translateZ , z_translation , 0 )} {( anim:paddle:tuxroot-rotateX , x_radians , 0 )} {( anim:jump:tuxroot-translateY , y_translation , 0 )} {( anim:jump:tuxroot-translateZ , z_translation , 0 )} {( anim:jump:tuxroot-rotateX , x_radians , 0 )} {( anim:intro:tuxroot-translateY , y_translation , 1 )} {( anim:intro:tuxroot-translateZ , z_translation , 1 )} {( anim:intro:tuxroot-rotateX , x_radians , 1 )} {( anim:intro:tuxroot-rotateY , y_radians , 1 )} {( anim:intro:tuxroot-rotateZ , z_radians , 1 )} {( anim:end_win:tuxroot-translateX , x_translation , 1 )} {( anim:end_win:tuxroot-translateY , y_translation , 1 )} {( anim:end_win:tuxroot-translateZ , z_translation , 1 )} {( anim:end_win:tuxroot-rotateX , x_radians , 1 )} {( anim:end_win:tuxroot-rotateY , y_radians , 1 )} {( anim:end_win:tuxroot-rotateZ , z_radians , 1 )} {( anim:end_lose:tuxroot-translateX , x_translation , 1 )} {( anim:end_lose:tuxroot-translateY , y_translation , 1 )} {( anim:end_lose:tuxroot-translateZ , z_translation , 1 )} {( anim:end_lose:tuxroot-rotateX , x_radians , 1 )} {( anim:end_lose:tuxroot-rotateY , y_radians , 1 )} {( anim:end_lose:tuxroot-rotateZ , z_radians , 1 )}} \
...
objcreate {s_sganim} {sg:tuxroot:chest:neck} \
	{-bound_animations} {{( anim:left_turn:neck-rotateZ , z_radians , 0 )} {( anim:right_turn:neck-rotateZ , z_radians , 0 )} {( anim:brake:neck-rotateX , x_radians , 0 )} {( anim:flap:neck-rotateX , x_radians , 0 )} {( anim:flap_trans:neck-rotateX , x_radians , 0 )} {( anim:paddle:neck-rotateX , x_radians , 0 )} {( anim:velocity:neck-rotateX , x_radians , 0 )} {( anim:force:neck-rotateX , x_radians , 0 )} {( anim:racing:neck-rotateX , x_radians , 0 )} {( anim:jump:neck-rotateX , x_radians , 0 )} {( anim:intro:neck-rotateX , x_radians , 1 )} {( anim:intro:neck-rotateY , y_radians , 1 )} {( anim:intro:neck-rotateZ , z_radians , 1 )} {( anim:end_lose:neck-rotateX , x_radians , 1 )} {( anim:end_lose:neck-rotateY , y_radians , 1 )} {( anim:end_lose:neck-rotateZ , z_radians , 1 )}} \
...
objcreate {s_sganim} {sg:tuxroot:chest:rightCollarbone:rightShoulder} \
	{-bound_animations} {{( anim:left_turn:rightShoulder-rotateX , x_radians , 0 )} {( anim:left_turn:rightShoulder-rotateY , y_radians , 0 )} {( anim:right_turn:rightShoulder-rotateX , x_radians , 0 )} {( anim:right_turn:rightShoulder-rotateY , y_radians , 0 )} {( anim:right_turn:rightShoulder-rotateZ , z_radians , 0 )} {( anim:brake:rightShoulder-rotateX , x_radians , 0 )} {( anim:brake:rightShoulder-rotateY , y_radians , 0 )} {( anim:brake:rightShoulder-rotateZ , z_radians , 0 )} {( anim:flap:rightShoulder-rotateX , x_radians , 0 )} {( anim:flap:rightShoulder-rotateY , y_radians , 0 )} {( anim:flap:rightShoulder-rotateZ , z_radians , 0 )} {( anim:flap_trans:rightShoulder-rotateX , x_radians , 0 )} {( anim:flap_trans:rightShoulder-rotateY , y_radians , 0 )} {( anim:flap_trans:rightShoulder-rotateZ , z_radians , 0 )} {( anim:paddle:rightShoulder-rotateX , x_radians , 0 )} {( anim:paddle:rightShoulder-rotateY , y_radians , 0 )} {( anim:paddle:rightShoulder-rotateZ , z_radians , 0 )} {( anim:velocity:rightShoulder-rotateZ , z_radians , 0 )} {( anim:force:rightShoulder-rotateX , x_radians , 0 )} {( anim:racing:rightShoulder-rotateX , x_radians , 0 )} {( anim:jump:rightShoulder-rotateX , x_radians , 0 )} {( anim:jump:rightShoulder-rotateY , y_radians , 0 )} {( anim:jump:rightShoulder-rotateZ , z_radians , 0 )} {( anim:intro:rightShoulder-rotateX , x_radians , 1 )} {( anim:intro:rightShoulder-rotateY , y_radians , 1 )} {( anim:intro:rightShoulder-rotateZ , z_radians , 1 )} {( anim:end_win:rightShoulder-rotateX , x_radians , 1 )} {( anim:end_win:rightShoulder-rotateY , y_radians , 1 )} {( anim:end_win:rightShoulder-rotateZ , z_radians , 1 )} {( anim:end_lose:rightShoulder-rotateX , x_radians , 1 )} {( anim:end_lose:rightShoulder-rotateY , y_radians , 1 )} {( anim:end_lose:rightShoulder-rotateZ , z_radians , 1 )}} \
	{-position} {-0.097999997437 0.0439999997616 0.0}
...
objcreate {s_object3dinst} {sg:tuxroot:chest:rightCollarbone:rightShoulder:rightElbow:lowerRightArm} \
	{-object3d} {objects:tuxrightarm2} \
	{-cast_shadow} {1}

objcreate {s_object3dinst} {sg:tuxroot:chest:rightCollarbone:rightShoulder:upperRightArm} \
	{-object3d} {objects:tuxrightarm1} \
	{-cast_shadow} {1}

objcreate {s_object3dinst} {sg:tuxroot:chest:rightCollarbone:rightShoulder2} \
	{-object3d} {objects:tuxrightshoulder} \
	{-cast_shadow} {1}

objcreate {s_sganim} {sg:tuxroot:chest:leftCollarbone} \
	{-bound_animations} {{( anim:paddle:leftCollarbone-rotateX , x_radians , 0 )} {( anim:jump:leftCollarbone-rotateX , x_radians , 0 )} {( anim:intro:leftCollarbone-rotateX , x_radians , 1 )} {( anim:intro:leftCollarbone-rotateY , y_radians , 1 )} {( anim:intro:leftCollarbone-rotateZ , z_radians , 1 )} {( anim:end_lose:leftCollarbone-rotateX , x_radians , 1 )} {( anim:end_lose:leftCollarbone-rotateY , y_radians , 1 )} {( anim:end_lose:leftCollarbone-rotateZ , z_radians , 1 )}} \
	{-position} {0.15000000596 0.144999995828 0.0}
...
objcreate {s_object3dinst} {sg:tuxroot:chest:leftCollarbone:leftShoulder:leftElbow:lowerLeftArm} \
	{-object3d} {objects:tuxleftarm2} \
	{-cast_shadow} {1}

objcreate {s_object3dinst} {sg:tuxroot:chest:leftCollarbone:leftShoulder:upperLeftArm} \
	{-object3d} {objects:tuxleftarm1} \
	{-cast_shadow} {1}

objcreate {s_object3dinst} {sg:tuxroot:chest:leftCollarbone:leftShoulder1} \
	{-object3d} {objects:tuxleftshoulder} \
	{-cast_shadow} {1}

objcreate {s_object3dinst} {sg:tuxroot:chest:chest2} \
	{-object3d} {objects:tuxchest} \
	{-cast_shadow} {1}

objcreate {s_sganim} {sg:tuxroot:tail} \
	{-bound_animations} {{( anim:brake:tail-rotateX , x_radians , 0 )} {( anim:flap:tail-rotateX , x_radians , 0 )} {( anim:flap_trans:tail-rotateX , x_radians , 0 )} {( anim:paddle:tail-rotateX , x_radians , 0 )} {( anim:velocity:tail-rotateX , x_radians , 0 )} {( anim:force:tail-rotateX , x_radians , 0 )} {( anim:racing:tail-rotateX , x_radians , 0 )} {( anim:jump:tail-rotateX , x_radians , 0 )} {( anim:intro:tail-rotateX , x_radians , 1 )} {( anim:intro:tail-rotateY , y_radians , 1 )} {( anim:intro:tail-rotateZ , z_radians , 1 )}} \
	{-position} {0.0 -0.0659999996424 -0.193000003695}

objcreate {s_object3dinst} {sg:tuxroot:tail:tail} \
	{-object3d} {objects:tuxtail}
...
objcreate {s_sganim} {sg:tuxroot:rightHip:rightKnee} \
	{-bound_animations} {{( anim:left_turn:rightKnee-rotateX , x_radians , 0 )} {( anim:right_turn:rightKnee-rotateX , x_radians , 0 )} {( anim:brake:rightKnee-rotateX , x_radians , 0 )} {( anim:flap:rightKnee-rotateX , x_radians , 0 )} {( anim:flap_trans:rightKnee-rotateX , x_radians , 0 )} {( anim:paddle:rightKnee-rotateX , x_radians , 0 )} {( anim:velocity:rightKnee-rotateX , x_radians , 0 )} {( anim:force:rightKnee-rotateX , x_radians , 0 )} {( anim:racing:rightKnee-rotateX , x_radians , 0 )} {( anim:jump:rightKnee-rotateX , x_radians , 0 )} {( anim:intro:rightKnee-rotateX , x_radians , 1 )} {( anim:intro:rightKnee-rotateY , y_radians , 1 )} {( anim:intro:rightKnee-rotateZ , z_radians , 1 )} {( anim:end_win:rightKnee-rotateX , x_radians , 1 )} {( anim:end_lose:rightKnee-rotateX , x_radians , 1 )} {( anim:end_lose:rightKnee-rotateY , y_radians , 1 )} {( anim:end_lose:rightKnee-rotateZ , z_radians , 1 )}} \
...
objcreate {s_object3dinst} {sg:tuxroot:rightHip:rightKnee:rightAnkle:rightToe:rightToes} \
	{-object3d} {objects:tuxrighttoes} \
	{-cast_shadow} {1}

objcreate {s_object3dinst} {sg:tuxroot:rightHip:rightKnee:rightAnkle:rightHeel} \
	{-object3d} {objects:tuxrightfoot} \
	{-cast_shadow} {1}

objcreate {s_object3dinst} {sg:tuxroot:rightHip:rightKnee:rightLowerLeg} \
	{-object3d} {objects:tuxrightleg2} \
	{-cast_shadow} {1}

objcreate {s_object3dinst} {sg:tuxroot:rightHip:rightUpperLeg} \
	{-object3d} {objects:tuxrightleg1} \
	{-cast_shadow} {1}

objcreate {s_sganim} {sg:tuxroot:leftHip} \
	{-bound_animations} {{( anim:left_turn:leftHip-rotateX , x_radians , 0 )} {( anim:right_turn:leftHip-rotateX , x_radians , 0 )} {( anim:right_turn:leftHip-rotateY , y_radians , 0 )} {( anim:right_turn:leftHip-rotateZ , z_radians , 0 )} {( anim:brake:leftHip-rotateX , x_radians , 0 )} {( anim:brake:leftHip-rotateY , y_radians , 0 )} {( anim:brake:leftHip-rotateZ , z_radians , 0 )} {( anim:flap:leftHip-rotateX , x_radians , 0 )} {( anim:flap_trans:leftHip-rotateX , x_radians , 0 )} {( anim:paddle:leftHip-rotateX , x_radians , 0 )} {( anim:velocity:leftHip-rotateX , x_radians , 0 )} {( anim:force:leftHip-rotateX , x_radians , 0 )} {( anim:force:leftHip-rotateZ , z_radians , 0 )} {( anim:racing:leftHip-rotateX , x_radians , 0 )} {( anim:racing:leftHip-rotateZ , z_radians , 0 )} {( anim:jump:leftHip-rotateX , x_radians , 0 )} {( anim:intro:leftHip-rotateX , x_radians , 1 )} {( anim:intro:leftHip-rotateZ , z_radians , 1 )} {( anim:intro:leftHip-rotateY , y_radians , 1 )} {( anim:end_win:leftHip-rotateX , x_radians , 1 )} {( anim:end_win:leftHip-rotateY , y_radians , 1 )} {( anim:end_win:leftHip-rotateZ , z_radians , 1 )} {( anim:end_lose:leftHip-rotateX , x_radians , 1 )} {( anim:end_lose:leftHip-rotateY , y_radians , 1 )} {( anim:end_lose:leftHip-rotateZ , z_radians , 1 )}} \
	{-position} {0.107000000775 -0.0750000029802 0.0}

objcreate {s_sganim} {sg:tuxroot:leftHip:leftKnee} \
	{-bound_animations} {{( anim:left_turn:leftKnee-rotateX , x_radians , 0 )} {( anim:right_turn:leftKnee-rotateX , x_radians , 0 )} {( anim:brake:leftKnee-rotateX , x_radians , 0 )} {( anim:flap:leftKnee-rotateX , x_radians , 0 )} {( anim:flap_trans:leftKnee-rotateX , x_radians , 0 )} {( anim:paddle:leftKnee-rotateX , x_radians , 0 )} {( anim:velocity:leftKnee-rotateX , x_radians , 0 )} {( anim:force:leftKnee-rotateX , x_radians , 0 )} {( anim:racing:leftKnee-rotateX , x_radians , 0 )} {( anim:jump:leftKnee-rotateX , x_radians , 0 )} {( anim:intro:leftKnee-rotateX , x_radians , 1 )} {( anim:intro:leftKnee-rotateY , y_radians , 1 )} {( anim:intro:leftKnee-rotateZ , z_radians , 1 )} {( anim:end_win:leftKnee-rotateX , x_radians , 1 )} {( anim:end_lose:leftKnee-rotateX , x_radians , 1 )} {( anim:end_lose:leftKnee-rotateY , y_radians , 1 )} {( anim:end_lose:leftKnee-rotateZ , z_radians , 1 )}} \
	{-position} {0.0 -0.17499999702 0.0}
